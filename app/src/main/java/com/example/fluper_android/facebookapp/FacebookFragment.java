...
/**
 * Created by fluper-android on 3/5/17.
 */
...
public class FacebookFragment extends Fragment {
    ...
    private ArrayList<Images> mGridData;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        mGridAdapter = new GridViewAdapter(getContext(), R.layout.list_single, mGridData);
        ...
        loginButton.registerCallback(callbackManager, new FacebookCallback<LoginResult>() {
            ...
            public void onSuccess(LoginResult loginResult) {
                ...
                getAlbums.setVisibility(View.VISIBLE);
                toast.show();
                handlePendingAction();
                updateUI();
            }
        ...
        getAlbums = (Button) v.findViewById(R.id.getAlbumsButton);
        ...
        getAlbums.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.d("AccessToken", AccessToken.getCurrentAccessToken().toString());
                            ...
                            public void onCompleted(JSONObject object, GraphResponse response) {
                                ...
                                try {
                                    if (response.getError() == null) {
                                        ...
                                        JSONObject joAlbum = joMain.getJSONObject("albums");
                                        JSONArray jaData = joAlbum.optJSONArray("data");
                                        for (int i = 0; i < jaData.length(); i++) {
                                            JSONObject json = jaData.getJSONObject(i);
                                            JSONObject joPicture = json.getJSONObject("picture");
                                            JSONObject joData = joPicture.getJSONObject("data");
                                            Images objImages = new Images();//Images is custom class with string url field
                                            objImages.setImage_url(joData.getString("url"));
                                            mGridData.add(objImages);//lstFBImages is Images object array
                                        }
                ...
                Bundle parameters = new Bundle();
                parameters.putString("fields", "id,name,albums{picture{url}}");
                request.setParameters(parameters);
                request.executeAsync();
            }
        });
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!postingEnabled) {
                    ...
                    getAlbums.setVisibility(View.GONE);
                }
            }
        });
        return v;
    ...
    private void updateUI() {
        ...
        if (enableButtons && profile != null) {
            ...
            Bitmap icon = BitmapFactory.decodeResource(getContext().getResources(), R.drawable.recipe);
